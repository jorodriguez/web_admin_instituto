<template>
  <div>
    ...
    <div
      ...
      v-if="!sucursal.plan_foto_cursos || sucursal.credito_fotos <= 0"
    >
      <i class="fa fa-meh-o" aria-hidden="true"></i>
      <span v-if="!sucursal.plan_foto_cursos">
        <strong>AVISO!</strong>
        No es posible subir fotos, por favor comunicate con el equipo de soporte y pide
        que te
        <strong>actualice tu plan</strong>
        .
      </span>
      <span v-if="sucursal.credito_fotos <= 0">
        <strong>AVISO!</strong>
        No es posible subir fotos, por favor comunicate con el equipo de soporte y pide
        que aumente el crédito en fotos.
      </span>
    </div>
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
            <div class="mx-auto">
              ...
              <croppa
                v-else
                v-model="myCroppa"
                :initial-image="`${curso.foto_curso}`"
                :width="200"
                :height="200"
                :quality="0.9"
...
export default {
  ...
  methods: {
    ...
    subir(blob) {
      ...
      data.append("uid_curso", this.curso.uid);
